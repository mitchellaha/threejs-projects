...
{	
	...
	function setupScene ()
	{
		...
		for (let i = 0; i < 5000; i++) {
            ...
            verticies.push(star.x, star.y, star.z);
			starGeometry.setAttribute('position', new THREE.Float32BufferAttribute(verticies, 3));
            ...
            // starGeometry.setAttribute('color', new THREE.Float32BufferAttribute(color.toArray(), 3));
		}
